...
def test_pawn_free_forward_W():
    assert example_pawn_data_W == [(2,3),(3,3)]

def test_pawn_one_forward_W():
    assert example_pawn_data_W == [(2,3)]

def test_pawn_cant_move_W():
    assert example_pawn_data_W == []

## vague
def test_pawn_eat_pawn_W():
    assert Pawn(2,3,"White") == [(3,2)]



def test_pawn_free_forward_B():
    assert example_pawn_data_B == [(5,7),(4,7)]

def test_pawn_one_forward_B():
    assert example_pawn_data_B == [(5,7)]

def test_pawn_cant_move_B():
    assert example_pawn_data_B == []

## vague
def test_pawn_eat_pawn_B():
